...
export function simulateDispatch(_origin: { lat: number; lng: number }) {
  const base = Date.now();
  const trained = [
    {
      name: 'Anjali M.',
      role: 'Trained first responder · Anekal',
      distanceKm: 2.4,
      etaMin: 4,
      acceptAt: base + 6_000,
      accept: true,
    ...
    {
      name: 'Ravi K.',
      role: 'Trained first responder · Sarjapur',
      distanceKm: 6.1,
      etaMin: 11,
      acceptAt: base + 9_000,
      accept: true,
  ...
  const rescue = [
    {
      name: 'Bannerghatta Rescue Cell',
      role: 'Snake rescue team · certified',
      distanceKm: 3.0,
      etaMin: 6,
      acceptAt: base + 12_000,
      accept: true,
    },
    {
      ...
      distanceKm: 8.2,
      etaMin: 14,
      acceptAt: base + 15_000,
      accept: true,
    },
  ];
  const ambulance = [
    {
      name: 'Ambulance 108 · BLR-South',
      role: 'State ambulance · ALS',
      distanceKm: 4.6,
      etaMin: 9,
      acceptAt: base + 8_000,
      accept: true,
    ...
    {
      name: 'Ambulance 108 · BLR-Rural',
      role: 'State ambulance · BLS',
      distanceKm: 9.9,
      etaMin: 18,
      acceptAt: base + 11_000,
      accept: true,
    },
  ];
